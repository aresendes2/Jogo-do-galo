"""
Entry-point do Jogo do Galo.

Nota: este ficheiro existe para bater certo com as instruções (python3 main.py).
O código do menu vive aqui (era o antigo main2.py).
"""
